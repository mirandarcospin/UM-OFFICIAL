...
function scene:create( event )
	...
	local title = display.newText( "Cash system", display.contentCenterX, 80, native.systemFont, 32 )
...
local tabButtons = {
	...
	{ defaultFile="buttonnext.png", overFile="buttonnext.png", width = 120, height = 55, onPress=onFourthView, selected=true},
}
